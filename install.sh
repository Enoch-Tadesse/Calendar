...
install_x86_64() {
    ...
    curl -O https://raw.githubusercontent.com/Enoch-Tadesse/ECal/main/releases/latest/download/ecal-linux-x86_64
...
install_arm64() {
    ...
    curl -O https://raw.githubusercontent.com/Enoch-Tadesse/ECal/main/releases/latest/download/ecal-linux-arm64
